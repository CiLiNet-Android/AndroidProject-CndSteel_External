...
public class StockAccordingStockQueryResultDetailListBean extends WebServiceBean {

	private static final long serialVersionUID = 2229472821637380918L;
	...
	public DefaultHandler getXmlParserHandler() {
		DefaultHandler _defaultHandler = new DefaultHandler(){
			...
			public void characters(char[] ch, int start, int length) throws SAXException {
				...
				}else if("pkgNo".equals(mCurrentElementName)){
					mStockBean.pkgNo = _text;
