...
public class StockAccordingGoodsQueryResultDetailAdapter extends AbsBaseAdapter<StockBean> {

	public StockAccordingGoodsQueryResultDetailAdapter(Context context) {
		super(context);
	}
