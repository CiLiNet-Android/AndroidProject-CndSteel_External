...
public class StockAccordingContractQueryResultDetailAdapter extends AbsBaseAdapter<StockBean> {

	public StockAccordingContractQueryResultDetailAdapter(Context context) {
		super(context);
	}
