 ...
 * @author zhxl
 */
public class YearMonthDayPickerDialog extends Dialog implements OnWheelScrollListener,View.OnClickListener {
	...
	public static class Builder {
		...
		public YearMonthDayPickerDialog create(){
			final YearMonthDayPickerDialog _datePickerDialog = new YearMonthDayPickerDialog(mContext);
	...
	protected YearMonthDayPickerDialog(Context context) {
		super(context);
	}

	protected YearMonthDayPickerDialog(Context context, int theme) {
		super(context, theme);
	}

	protected void initViews() {
		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.dialog_year_month_day_picker);
	...
	public void onClick(View view) {
		if(null != mOnDateSelectedListener){
			...
			_selectedCalendar.set(mSelectedYear, mSelectedMonth - 1, mSelectedDay);
