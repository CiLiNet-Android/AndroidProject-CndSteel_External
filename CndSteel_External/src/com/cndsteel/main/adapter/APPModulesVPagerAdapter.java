package com.cndsteel.main.adapter;
...
import com.cndsteel.framework.utils.UnitTransformUtil;
...
public class APPModulesVPagerAdapter extends PagerAdapter {
	...
	private View createViewPage(ArrayList<APPModuleBean> appModuleBeans){
		...
		_mainAppModulesGridV.setVerticalSpacing(UnitTransformUtil.dip2px(mContext, 20));
