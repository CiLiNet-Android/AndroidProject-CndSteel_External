...
public class PlanQueryActivity extends FrameActivity implements View.OnClickListener,DatePickerDialog.OnDateSelectedListener,AbsSpinner.OnItemClickListener {
	...
	private void initVariables() {
		mQueryParamYear = DateUtils.getCurrentYear();
		mQueryParamMonth = DateUtils.getCurrentMonth();
...
//		imgBtn_topRight.setBackgroundResource(R.drawable.add);
		...
		txtV_planDate.setText(DateUtils.getFormatDate(QUERY_DATE_FORMAT));
	...
	public void onDateSelected(Date selectedDate) {
		txtV_planDate.setText(DateUtils.getFormatDateTime(selectedDate, QUERY_DATE_FORMAT));
		
		mQueryParamYear = DateUtils.getFormatDateTime(selectedDate, "yyyy");
		mQueryParamMonth = DateUtils.getFormatDateTime(selectedDate, "MM");
	}
